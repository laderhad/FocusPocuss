using FocusPocuss.Domain.Events;
using Microsoft.Extensions.Logging;

namespace FocusPocuss.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("FocusPocuss Domain Event: {DomainEvent}", notification.GetType().Name);
