using FocusPocuss.Application.TodoItems.Commands.CreateTodoItem;
using FocusPocuss.Application.TodoItems.Commands.UpdateTodoItem;
using FocusPocuss.Application.TodoItems.Commands.UpdateTodoItemDetail;
using FocusPocuss.Application.TodoLists.Commands.CreateTodoList;
using FocusPocuss.Domain.Entities;
using FocusPocuss.Domain.Enums;

namespace FocusPocuss.Application.FunctionalTests.TodoItems.Commands;
